...
- Create Angular project with ng: `ng new microwavesupervisorapi.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`microwavesupervisorapi.client.esproj`).
